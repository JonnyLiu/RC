...
function McSuperPanel(e) {
    ...
    var A = "replace",
        ...
        r = "addEventListener",
        b = "style";
    if (typeof String.prototype.trim !== "function") String.prototype.trim = function() { return this[A](/^\s+|\s+$/g, "") };
    var m = document,
        x = "getElementById",
        i = setTimeout,
        q = function(a, b) { return m[a](b) },
        M = function(a, d) {
        ...
        k = function(b, a) { return L(b[h].split(" "), a) },
        z = function(a, b, c) {
            if (!k(a, b))
                if (!a[h]) a[h] = b;
                else if (c) a[h] = b + " " + a[h];
        ...
        I = function(e) {
            ...
            if (!k(a, "panel-button")) { a = a.parentNode; if (a && !k(a, "panel-button")) a = a.parentNode; if (a && !k(a, "panel-button")) return }
            if (k(f[0], "active")) t();
            else {
        ...
        C = function() { return window.innerWidth || m.documentElement.clientWidth || m.body.clientWidth },
        D = function() { return window.screen.width },
        B = function() {
            var a = c.e[0],
                e = c.e[1],
                h = c.f === 1;
        ...
        u = function(c, b) { var a = false; if (c[d] > b) { a = c.charAt(b).toLowerCase() == "y"; if (!b && !f) a = false } return a },
        s = function(a) { return a[A](/\s/g, "").split(",") },
        G = function() {
            a = q(x, e.panelId);
            if (a) {
                ...
                var m = s(e.slideInFrom),
                    A = m[d] > 1 ? m[1] : "120%";
                c = { a: m[0], b: A, c: h[d] > 1 ? parseInt(h[1]) : 0, d: h[d] > 1 ? h[1].indexOf("d") != "-1" : 0, e: [r, w, k, l], f: 1, g: 1 };
